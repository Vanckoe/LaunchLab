...
const buttonVariants = cva(
  'xs:py-6 xs:text-[18px] flex items-center justify-center gap-[10px] text-nowrap leading-[19.8px] rounded-2xl px-2 py-4 text-[14px] font-semibold transition-colors duration-150',
  {
    variants: {
      variant: {
        primary:
